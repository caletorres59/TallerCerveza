...
var app = angular.module("appControladorLogo", []);
...
app.controller('CtlLogo', function ($scope,presentacionService) {

    /*Se inicializa el modelo*/
    $scope.identificacion = "";
    $scope.presentaciones = []; 
     alert($scope.identificacion.logo);  
    ...
    $scope.guardar = function (form) {
         ...
         * uso de ese paradigma*/
         alert($scope.identificacion.logo+"form");
